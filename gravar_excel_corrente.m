...
mensagem=improved_xlswrite([caminho '\' nome],{'Taxa de aquisição'},...
...
mensagem=improved_xlswrite([caminho '\' nome],{'Período de amostragem'},...
...
mensagem=improved_xlswrite([caminho '\' nome],{'Perfilador acústico'},...
    'Dados de corrente processados','B3');
mensagem=improved_xlswrite([caminho '\' nome],{'AWAC AST Nortek'},...
    'Dados de corrente processados','B4');
mensagem=improved_xlswrite([caminho '\' nome],{'2 Hz'},...
    'Dados de corrente processados','B6');
mensagem=improved_xlswrite([caminho '\' nome],{'30 minutos'},...
    'Dados de corrente processados','B7');
mensagem=improved_xlswrite([caminho '\' nome],{'5 minutos'},...
...
mensagem=improved_xlswrite([caminho '\' nome],tempo-693960,...
    'Dados de corrente processados','B17');
...
mensagem=improved_xlswrite([caminho '\' nome],vtr_uv,...
    'Dados de corrente processados','C17');
