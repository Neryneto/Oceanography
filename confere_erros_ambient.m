function [out_vel out_dir num_range num_rep num_spike num_gap num_sinc num_ambient,...
    dados_excluidos dados_eliminados tempo u v]=confere_erros_ambient(in_vel,...
...
[amb_max_l amb_max_c]=find(in_vel>=0.5);
[amb_min_l amb_min_c]=find(in_vel<=-0.5);
...
out_vel(l_spike-1,c_spike)=nan;
out_dir(l_spike-1,c_spike)=nan;  
clear lixo lixo_2

dados_eliminados=num_range+num_gap+num_rep+num_sinc+num_spike+num_ambient;
end
