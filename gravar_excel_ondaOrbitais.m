...
mensagem=improved_xlswrite([caminho '\' nome],{'Hm0 (m)'},...
    'Ondas','B13');
mensagem=improved_xlswrite([caminho '\' nome],{'Hm10 (m)'},...
    'Ondas','C13');
...
mensagem=improved_xlswrite([caminho '\' nome],{'600 kHz'},...
    'Dados de corrente processados','B6');
mensagem=improved_xlswrite([caminho '\' nome],{'60 minutos'},...
...
mensagem=improved_xlswrite([caminho '\' nome],tempo(end)-693960,...
    'Dados de corrente processados','B10');
...
mensagem=improved_xlswrite([caminho '\' nome],nanmin(matriz(:,1)),...
    'Ondas','O4');
mensagem=improved_xlswrite([caminho '\' nome],nanmax(matriz(:,4)),...
    'Ondas','O5');
mensagem=improved_xlswrite([caminho '\' nome],nanmin(matriz(:,4)),...
    'Ondas','O6');
ensagem=improved_xlswrite([caminho '\' nome],nanmax(matriz(:,8)),...
    'Ondas','O7');
mensagem=improved_xlswrite([caminho '\' nome],nanmin(matriz(:,8)),...
    'Ondas','O8');
mensagem=improved_xlswrite([caminho '\' nome],nanmax(matriz(:,8))-nanmin(matriz(:,8)),...
    'Ondas','O9');
...
mensagem=improved_xlswrite([caminho '\' nome],num_tilt,...
    'Ondas','O18');
mensagem=improved_xlswrite([caminho '\' nome],num_gap+num_rep+num_sinc+num_tilt,...
    'Ondas','O19');
mensagem=improved_xlswrite([caminho '\' nome],size(tempo,1)-(num_gap+num_rep+num_sinc+num_tilt),...
    'Ondas','O20');
mensagem=improved_xlswrite([caminho '\' nome],((size(tempo,1)-(num_gap+num_rep+num_sinc+num_tilt))/size(tempo,1))*100,...
    'Ondas','O21');
